...
\- Carlton, finished `r combined_ladder |> filter(str_detect(team_club_name,"Carlton")) |>  pull(position_current) |>  toOrdinal::toOrdinal()` were only projected to finish `r combined_ladder |> filter(str_detect(team_club_name,"GWS")) |>  pull(position_predicted) |>  toOrdinal::toOrdinal()`.
